...
const float GRID_RESOLUTION = 0.1f; // 网格分辨率 0.05 米
const int X_MIN = -11, X_MAX = 23, Y_MIN = -7, Y_MAX = 11, Z_MIN = -1, Z_MAX = 6;
const std::string SAVE_PATH = "/home/lj/文档/DebugfilterworldFinal/";  // 保存路径
...
int main() {
    ...
    for (int i = 0; i < csvCount;++i){
        // 拼接文件路径和文件名
        std::string filePath = folder_path + "/pc_filter_" + std::to_string(i) + ".csv";
